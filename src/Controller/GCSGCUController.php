...
class GCSGCUController extends AbstractController
{
     ...
     */
    public function index(GCSGCURepository $gCSGCURepository): Response
    {
     ...
     */
    public function show(GCSGCU $gCSGCU): Response
    {
     ...
     */
    public function edit(Request $request, GCSGCU $gCSGCU): Response
    {
        $form = $this->createForm(GCSGCUType::class, $gCSGCU);
        $form->handleRequest($request);
     ...
     */
    public function delete(Request $request, GCSGCU $gCSGCU): Response
    {
